...
Usage: ./worsica_sentinel_script_ut_coastal.py  [ZIPFILE] [ROI-NAME] [ROI-POLYGON] [BATHYMETRY-THRESHOLD] [TOPOGRAPHY-THRESHOLD] [WI_THRESHOLD] [WATER_INDEX]
e.g: ./worsica_sentinel_script_ut_coastal.py  S2A_MSIL2A_20181229T113501_N0211_R080_T29SMC_20181229T124502
...
if __name__ == '__main__':
    if len(sys.argv) != 8:
        print(
            "Usage: ./worsica_sentinel_script_ut_coastal.py [IMAGESET_NAME_NO_ZIP_EXTENSION] [ROI-NAME] [ROI-POLYGON] [BATHYMETRY-THRESHOLD] [TOPOGRAPHY-THRESHOLD] [WI_THRESHOLD] [WATER_INDEX]")
        exit(1)
    else:
