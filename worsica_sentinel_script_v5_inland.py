...
Usage: ./worsica_sentinel_script_v5_inland.py  [ZIPFILE] [ROI-NAME] [ROI-POLYGON] [BATH] [TOPO] [MNDWI_THRESHOLD] [WATER_INDEX]
e.g: ./worsica_sentinel_script_v5_inland.py  S2A_MSIL2A_20181229T113501_N0211_R080_T29SMC_20181229T124502
...
if __name__ == '__main__':
    if len(sys.argv) != 7:
        print(
            "Usage: ./worsica_sentinel_script_v5_inland.py [IMAGESET_NAME_NO_ZIP_EXTENSION] [ROI-NAME] [BATHYMETRY-THRESHOLD] [TOPOGRAPHY-THRESHOLD] [WI_THRESHOLD] [WATER_INDEX]")
        exit(1)
    else:
